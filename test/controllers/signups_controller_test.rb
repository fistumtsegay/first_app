...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { address: @signup.address, password: @signup.password, userid: @signup.userid, username: @signup.username }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { address: @signup.address, password: @signup.password, userid: @signup.userid, username: @signup.username }
    assert_redirected_to signup_path(assigns(:signup))
  end
